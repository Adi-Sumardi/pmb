                            ...
                            <tbody>
                                @foreach ($dt_pendaftars as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <!-- File Akta Kelahiran -->
                                            <a href="{{ asset('storage/' . ($item->akta_kelahiran_path ?? ' ')) }}" target="_blank" class="me-2" title="Akta Kelahiran">
                                                <i class="bi bi-file-earmark-text-fill text-info fs-5"></i> Akta
                                            </a>

                                            <a href="{{ asset('storage/' . ($item->kartu_keluarga_path ?? ' ')) }}" target="_blank" class="me-2" title="Kartu Keluarga">
