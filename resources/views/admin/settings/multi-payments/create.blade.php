        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="fw-bold text-dark mb-1">
                    ...
                    Tambah Multi Payment Item
                </h2>
                <p class="text-muted small mb-0">Buat item pembayaran baru</p>
            </div>
                ...
                <div class="card border-0 shadow-sm" data-aos="fade-up">
                    <div class="card-header bg-white border-bottom py-3">
                        <h5 class="card-title mb-0 fw-bold">
                            ...
                            Form Tambah Multi Payment Item
                        </h5>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('admin.settings.multi-payments.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" required placeholder="Contoh: Buku Paket SD Kelas 1">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="category" name="category" required>
                                            ...
                                            <option value="uniforms">Seragam</option>
                                            <option value="supplies">Alat Tulis</option>
                                ...
                                <div class="col-md-6" id="specificLevelDiv" style="display: none;">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6" id="sizeOptionsDiv" style="display: none;">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="size_m" name="available_sizes[]" value="M">
                                            <label class="form-check-label" for="size_m">M (Medium)</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="size_l" name="available_sizes[]" value="L">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="supplier" name="supplier" placeholder="Nama toko/supplier">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="stock_quantity" name="stock_quantity" placeholder="0" min="0">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Deskripsi detail item, spesifikasi, dll"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="auto_add_new_students" name="auto_add_new_students" value="1">
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4">
                                ...
                                <button type="submit" class="btn btn-purple">
                                    <i class="bi bi-check-circle me-1"></i>Simpan Item
                                </button>
                            </div>
                        </form>
                    </div>
